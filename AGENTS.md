...
- **Scripts / CI supply chain**: [`docs/guides/scripts-governance.md`](docs/guides/scripts-governance.md) — tiers, CODEOWNERS, PPE threat model; changes to `scripts/` and `.github/workflows/` need owner review
