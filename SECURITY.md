...
| Script / CI supply chain | On | Tier model + [scripts-governance.md](docs/guides/scripts-governance.md); `.github/CODEOWNERS`; Actions SHA-pinned; ShellCheck on `scripts/` |
